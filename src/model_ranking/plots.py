...
def plot_single_consistency_vs_performance(
    ...
    target_dataset: str,
    performance_scores: Dict[str, Dict[str, float]],
    base_consistency_path: str = "/path/to/consistency_results/patch_segmentation/mitochondria/transfer_results/consistency",
...
def plot_single_consistency_vs_performance_CVPR(
    ...
    performance_path: str = "/path/to/consistency_results/patch_segmentation/mitochondria/transfer_results/transfer_performance_scores.json",
    base_consistency_path: str = "/path/to/consistency_results/patch_segmentation/mitochondria/transfer_results/consistency",
    custom_legend_labels: Optional[Dict[str, str]] = None,
    figsize: Tuple[int, int] = (10, 8),
    alpha: float = 0.7,
