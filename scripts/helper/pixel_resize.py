...
from model_ranking import xy_resize_scaling, resize_data_label_pair, is_ndarray

config: Dict[str, Any] = {
    "path": "/scratch/talks/data/VNC/data_labeled_mito.h5",
    "source": "mitoEM",
    "raw_key": "raw",
    "label_key": "label",
    "roi": np.s_[:, :, :],
    "out_path": "/scratch/talks/data/pixel_resize",
