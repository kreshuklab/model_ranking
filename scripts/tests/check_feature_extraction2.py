...
source_model_path = "/g/kreshuk/talks/segmentation_ModelSelection/experiments/EPFL/BatchNorm/E_model_Unetr2/best_checkpoint.pytorch"
...
#     np.testing.assert_allclose(features[layer], data[f"{layer}_features"], atol=1e-3)
