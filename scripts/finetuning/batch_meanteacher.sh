...
#SBATCH --job-name=EtoR                         # specify the name of the job
...
#SBATCH -o ../SLURM/EtoR/outfile.out		    # specify the file to write the command line output to
#SBATCH -e ../SLURM/EtoR/errfile.err			# specify the file to write the error output to
...
python mean_teacher_train_pred.py --config /g/kreshuk/talks/model_ranking_results/Self-Finetuning/Mitochondria/configs2/self_training_config_EtoR.yaml