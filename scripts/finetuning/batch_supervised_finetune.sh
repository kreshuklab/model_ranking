...
#SBATCH --job-name=RtoH                         # specify the name of the job
...
#SBATCH -o ../SLURM/RtoH/outfile.out		        # specify the file to write the command line output to
#SBATCH -e ../SLURM/RtoH/errfile.err			    # specify the file to write the error output to
...
python supervised_finetune.py --config /g/kreshuk/talks/model_ranking_results/Supervised-Finetuning/Mitochondria/Rmito_to_Hmito_gap/self_training_config.yaml