...
#SBATCH --job-name=Vsource                         # specify the name of the job
...
#SBATCH -o ../SLURM/Vsource/outfile.out		        # specify the file to write the command line output to
#SBATCH -e ../SLURM/Vsource/errfile.err			    # specify the file to write the error output to
...
python update_batch_norm.py --config /g/kreshuk/talks/model_ranking_results/AdaptiveBatchNorm/Mitochondria/configs/model_update_configs/V_meta_config.yaml --sequential