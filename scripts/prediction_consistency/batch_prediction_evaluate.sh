...
#SBATCH --job-name=VtoE                         # specify the name of the job
...
#SBATCH -o ../SLURM/VtoE/outfile.out		        # specify the file to write the command line output to
#SBATCH -e ../SLURM/VtoE/errfile.err			    # specify the file to write the error output to
...
python batch_prediction_evaluate.py --config /g/kreshuk/talks/consistency_results/patch_segmentation/mitochondria/configs/finetuned_consistency/V_source/meta_config_VtoE.yaml