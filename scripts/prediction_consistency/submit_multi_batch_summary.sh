...
CONFIG_DIR="/g/kreshuk/talks/consistency_results/patch_segmentation/mitochondria/configs/finetuned_consistency"
...
#SBATCH --mem 1G			                    # specify the amount of memory per node
...
python batch_summary_metric.py --config $config_file
EOF
