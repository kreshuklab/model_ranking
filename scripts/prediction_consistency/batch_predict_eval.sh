...
python predict_eval.py --config /g/kreshuk/talks/model_ranking_results/Self-Finetuning/Mitochondria/VNC_to_Rmito_gap/feature_perturbation/train_predictions/VtoR_DO_a02_model1/epoch-0/pred.yml