...
from model_ranking.configs import (
    transformer_consistency_yaml_generator,
)
...
def main(
    ...
    meta_cfg = TransformerConsistencyMetaConfig.model_validate(cfg)
    run_config_paths = transformer_consistency_yaml_generator(meta_cfg)
