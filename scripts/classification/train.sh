...
#SBATCH --job-name=E_MNV3                         # specify the name of the job
...
#SBATCH -o ../SLURM/E_MNV3/outfile.out		    # specify the file to write the command line output to
#SBATCH -e ../SLURM/E_MNV3/errfile.err			# specify the file to write the error output to
...
python train_classification_model.py --config /g/kreshuk/talks/classification_models/Mitochondria/configs/EPFL/E_MNV3_train_config.yaml